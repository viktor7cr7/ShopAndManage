...
test.describe.skip('Проверка страницы Orders', () => {
    ...
    test('Фильтрация ордеров по поиску (ID)', async () => {
        ...
        const allOrdersMatch = await page.$$eval('.order-id', elements =>  elements.map(item => {
    ...
    test('Сортировка ордеров по цене (Price по возрастанию)', async () => {
        ...
        const allOrdersMatch = await page.$$eval('.order-price', elements =>  elements.map(item => {
    ...
    test('Сортировка ордеров по дате создания (Created по возрастанию)', async () => {
        ...
        const allOrdersMatch = await page.$$eval('.order-created', elements =>  elements.map(item => {
    ...
    test('Фильтрация ордеров по статусу paid (Оплачен)', async () => {
        ...
        const allOrdersMatch = await page.$$eval('.order-status', elements =>  elements.map(item => {
