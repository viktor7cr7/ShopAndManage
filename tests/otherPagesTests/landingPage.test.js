...
import {ForgotPasswordUser} from '../pages/userPage/forgotPasswordUser'
import { ForgotPasswordAdmin } from '../pages/forgotPasswordAdmin';

test.describe.skip('Тестирование лендинг страницы', () => {
    ...
    test('Вход юзера в систему', async ({page}) => {
        ...
        await landingPage.navigate()
        await landingPage.loginUser('victor@mail.ru', 'BETejEmm321')
    ...
    test('Вход администратора в систему', async ({page}) => {
        ...
        await landingPage.navigate()
        await landingPage.loginAdmin('victor@mail.ru', 'BETejEmm321')
