import {Landing, HomeLayout, Error, DashboardUser, DashboardAdmin, AddProduct, AllProducts, EditProducts, ProfileAdmin, AllProductShop, OrdersUser, AboutOrder, AddFunds, TransactionTable, ProfileUser, ForgotPassword, ResetPassword, Stats, VerifyEmail} from './pages'
