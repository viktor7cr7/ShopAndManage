    ...
    <Wrapper>
      <div className="product-containter">
        ...
        <div className="product-content">
          ...
          <div className="product_img" onMouseEnter={() => setDisplay(true)} onMouseLeave={() => setDisplay(false)}>
            <Description display={display} className="product-description">
              <button className="button-descr" onClick={hanldeModalDesciption}>
            ...
            <img
              src={
                image_url ||
                'https://play-lh.googleusercontent.com/vka7aPgijD-s3jvVMg4afKGvWrEjwBfKEZxiK0Eh9hGpFQt4MRH14Xb2tYON_oABzCpE=w240-h480-rw'
              }
              alt="product_img"
            ></img>
          </div>
        ...
        <div
          ...
          style={percentage ? { justifyContent: 'center' } : { justifyContent: 'space-between' }}
        >
          ...
          <button
            ...
            style={percentage ? { height: '30px' } : { heigth: '40px' }}
          >
            Buy Now
          </button>
      ...
      <DescriptionProduct
        handleCloseModal={hanldeModalDesciption}
        id={product_id}
