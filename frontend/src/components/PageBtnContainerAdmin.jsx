...
const PageBtnContainer = () => {
  ...
  const renderPageButtons = () => {
    const pageButtons = [];
    pageButtons.push(addPageButton({ pagesNumber: 1, activeClass: currentPage === 1 }));
    ...
    if (currentPage !== 1 && currentPage !== 2) {
      pageButtons.push(addPageButton({ pagesNumber: currentPage - 1, activeClass: false }));
    }

    if (currentPage !== 1 && currentPage !== numOfPages) {
      pageButtons.push(addPageButton({ pagesNumber: currentPage, activeClass: true }));
    }
    ...
    pageButtons.push(addPageButton({ pagesNumber: numOfPages, activeClass: currentPage === numOfPages }));
    return pageButtons;
  };
