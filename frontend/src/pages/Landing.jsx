        ...
        <div className="container">
          <div className="section left">
            ...
            <Form method="post">
              ...
              <div className="action-btn">
                <button type="submit" className="btn" id="user-login-button">
                  Войти
                </button>
                <Link to="/register/user" type="button" className="btn" id="user-register">
                  Регистрация
                </Link>
                <Link to="forgot-password/user" type="button" className="btn" id="user-forgot-password">
                  Забыли пароль?
                </Link>
              </div>
            </Form>
          ...
          <div className="section right">
            ...
            <Form method="post">
              ...
              <div className="action-btn">
                <button type="submit" className="btn" id="admin-login-button">
                  Войти
                </button>
                <Link to="/register/admin" type="button" className="btn" id="admin-register">
                  Регистрация
                </Link>
                <Link to="forgot-password/admin" type="button" className="btn" id="admin-forgot-password">
                  Забыли пароль?
                </Link>
              </div>
            </Form>
