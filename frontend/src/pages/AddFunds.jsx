...
const AddFunds = () => {
  ...
  return (
    <Wrapper>
      <div className="block-header" style={display ? { width: '100%' } : { width: '600px' }}>
        Add Funds
      </div>
        ...
        <WrapperWindow style={{ maxWidth: '600px' }}>
          <div className="modal-content" style={display ? { display: 'none' } : { display: 'block' }}>
            ...
            <div className="modal-header">
              ...
              <button className="action-add-funds">{isSubmitting ? 'Загрузка...' : 'Перейти к оплате'}</button>
            </div>
          </div>
        </WrapperWindow>
      </Form>
